        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    ...
                    try {
            Moyen_Transport moy = new Moyen_Transport(tfType.getText(),tfMatricule.getText(),tfMarque.getText(),parseInt(tfNbrPlace.getText()),parseDouble(tfFrais.getText()));
